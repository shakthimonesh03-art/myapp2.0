    ...
    <header className="topbar">
      <div className="container nav-shell">
        ...
        <nav className="navlinks">
          ...
          {isLoggedIn && <Link href="/bookings">Bookings</Link>}
          {isLoggedIn && <Link href="/notifications" aria-label="Notifications" title="Notifications">🔔</Link>}
          <Link href="/admin" className={role === 'admin' ? '' : 'top-link'}>Admin Panel</Link>
        </nav>
      </div>
    </header>
  );

...
export default function BookingPage() {
  ...
  const payNow = async () => {
    ...
    pushNotification(`Booking ${bookingId} confirmed. Email sent to ${user.email}`, 'EMAIL');
    ...
    setPaymentMessage(`Razorpay UPI payment successful. Confirmation email sent to ${user.email}.`);

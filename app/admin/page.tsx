  ...
  return (
    <section className="modern-page stack-xl">
      ...
      <div className="modern-grid">
        ...
        <article className="modern-card"><h3>Admin dashboard</h3><p>Overview of bookings, revenue, and refund trends.</p></article>
        ...
        <article className="modern-card"><h3>Reports dashboard</h3><p>Track booking conversion and cancellation rates.</p></article>
      </div>

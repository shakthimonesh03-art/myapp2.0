...
import { getActiveUser, loginUser, logoutUser, registerUser } from '@/lib/clientStore';
...
export default function AuthPage() {
  ...
  useEffect(() => {
    ...
    setActiveUser(user ? `${user.name} (${user.email})` : '');
  }, []);
  ...
  return (
    <section className="card stack auth-card">
      ...
      <p>Prototype auth with local persistence.</p>
